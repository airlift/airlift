...
import io.airlift.mcp.client.internal.MetaOnly;
        ...
        implements McpTasksConnection
{
    ...
    public static LegacyConnection createLegacyConnection(McpClient client, URI uri, SettingContainer settingContainer)
    {
        ...
        requestController = requestController.withSettingContainer(initialize(requestController));

        return new LegacyConnection(requestController, virtualThreadsNamed(uri.toString()));
    }
