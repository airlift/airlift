...
public class TestPersonResource {
    ...
    public void testGet() {
        ...
        assertThat(response.getEntity())
                .isEqualTo(new PersonRepresentation(
                        "foo@example.com", "Mr Foo", URI.create("http://localhost/v1/person/1")));
        assertThat(response.getMetadata().get("Content-Type"))
                .isNull(); // content type is set by JAX-RS based on @Produces
    }
    ...
    public void testPutNullValue() {
        assertThatThrownBy(() -> resource.put("foo", null)).isInstanceOf(NullPointerException.class);
    }
    ...
    public void testDeleteNullId() {
        assertThatThrownBy(() -> resource.delete(null)).isInstanceOf(NullPointerException.class);
    }
}
