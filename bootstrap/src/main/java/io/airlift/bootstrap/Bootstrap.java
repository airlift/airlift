...
public class Bootstrap
{
    ...
    private boolean envInterpolation;
    ...
    public Bootstrap enableEnvInterpolation()
    {
        return withEnvInterpolation(true);
    }
    ...
    public Set<ConfigPropertyMetadata> configure()
    {
        ...
        this.secretsResolver = envInterpolation ? new SecretsResolver(ImmutableMap.of("env", new EnvironmentVariableSecretProvider())) :
