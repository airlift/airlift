...
- Limited server-sent notifications during processing (e.g. for cancellation: [see spec](https://modelcontextprotocol.io/specification/2025-06-18/basic/utilities/cancellation))
...
- stdio protocol [(see spec)](https://modelcontextprotocol.io/specification/2025-06-18/basic/transports#stdio)
