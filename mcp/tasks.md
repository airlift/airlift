...
The draft MCP spec adds [support for tasks](https://modelcontextprotocol.io/specification/draft/basic/utilities/tasks):
...
See: [SessionTaskController](src/main/java/io/airlift/mcp/tasks/SessionTaskController.java).
