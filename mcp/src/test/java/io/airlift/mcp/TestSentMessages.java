...
public class TestSentMessages
{
    ...
    public TestSentMessages()
    {
        ...
        Map<String, String> properties = ImmutableMap.of("mcp.event-streaming.ping-threshold", "7d");
            ...
            throws Exception
    {
        ...
        client.mcpClient().callTool(new McpSchema.CallToolRequest("setVersion", ImmutableMap.of("type", "SYSTEM", "name", "tools")));
        client.mcpClient().callTool(new McpSchema.CallToolRequest("setVersion", ImmutableMap.of("type", "SYSTEM", "name", "prompts")));
        client.mcpClient().callTool(new McpSchema.CallToolRequest("setVersion", ImmutableMap.of("type", "SYSTEM", "name", "resources")));
