    ...
    public static void main(String[] args) {
        ...
        Module mcpModule = McpModule.builder()
                ...
                .withIdentityMapper(
                        ...
                        binding -> binding.toInstance(_ -> authenticated(new TestingIdentity("Mr. Tester"))))
                .build();
        ...
        log.info(
                "Local server started at: %s/mcp",
                injector.getInstance(HttpServerInfo.class).getHttpUri());
    }
}
