...
public class TestMcpConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(ConfigAssertions.recordDefaults(McpConfig.class)
                ...
                .setTaskPollInterval(new Duration(5, SECONDS)));
    }
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("mcp.task.ttl", "33m")
                .put("mcp.task.poll-interval", "7s")
                .build();
        ...
        McpConfig expected = new McpConfig()
                ...
                .setTaskTtl(new Duration(33, MINUTES))
                .setTaskPollInterval(new Duration(7, SECONDS));
