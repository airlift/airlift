...
public class TestTaskController
{
    ...
    {
        Task task = controller.createTask(REQUEST_CONTEXT);
        Optional<ToolResult> result = controller.currentTaskResult(task.taskId());
        assertThat(result).isPresent();
        assertThat(result.orElseThrow()).isInstanceOf(Task.class);

        Task taskResult = (Task) result.orElseThrow();
    ...
    public void testCurrentTaskResultCompleted()
    {
        ...
        Task completeResult = (Task) result.orElseThrow();
    ...
    {
        Task taskResult = (Task) controller.currentTaskResult(taskId).orElseThrow();
