...
public class TestTaskController
{
    ...
    public void testBlockUntilResult()
    {
        ...
        Future<TaskAdapter> future = newVirtualThreadPerTaskExecutor().submit(() ->
                taskController.blockUntilCondition(taskContextId, task.taskId(), java.time.Duration.ofDays(1), java.time.Duration.ofSeconds(1), hasMessage));
            ...
            throws InterruptedException, TimeoutException
    {
        ...
        taskController.blockUntilCondition(taskContextId, task.taskId(), java.time.Duration.ofMinutes(1), java.time.Duration.ofSeconds(1), isCompleted);
