...
public class TestTaskController
{
    ...
    public void testSimpleTaskTransitions()
    {
        ...
        Tasks tasks = taskController.tasksFor(taskContextId, "dummy");

        TaskFacade task = tasks.taskBuilder().createTask();
    ...
    public void testTaskContextIsolation()
    {
        ...
        Tasks tasks1 = taskController.tasksFor(taskContextId1, "dummy");
        TaskContextId taskContextId2 = taskController.createTaskContext(authenticated("dummy"));
        Tasks tasks2 = taskController.tasksFor(taskContextId2, "dummy");
