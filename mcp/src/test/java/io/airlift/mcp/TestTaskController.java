...
public class TestTaskController
{
    ...
    {
        Task task = controller.createTask(REQUEST_CONTEXT);
        Optional<Task> result = controller.getTask(task.taskId());
        assertThat(result).isPresent();
        assertThat(result.orElseThrow()).isInstanceOf(Task.class);

        Task taskResult = result.orElseThrow();
        assertThat(taskResult.status()).isEqualTo(TaskStatus.WORKING);
    ...
    public void testCurrentTaskResultCompleted()
    {
        ...
        Task completeResult = result.orElseThrow();
        assertThat(completeResult.status()).isEqualTo(TaskStatus.COMPLETED);
    ...
    public void testCurrentTaskResultInputRequired()
    {
        ...
        Task taskResult = result.orElseThrow();
        assertThat(taskResult.status()).isEqualTo(TaskStatus.INPUT_REQUIRED);
        assertThat(taskResult.inputRequests()).isPresent();
    }
    ...
    public void testCurrentTaskResultCancelled()
    {
        ...
        Task taskResult = result.orElseThrow();
        assertThat(taskResult.status()).isEqualTo(TaskStatus.CANCELLED);
    }

    @Test
    public void testCurrentTaskResultNotFound()
    {
        assertThat(controller.getTask(UUID.randomUUID().toString())).isEmpty();
    }
    ...
    {
        Task taskResult = controller.getTask(taskId).orElseThrow();
        CallToolResult callToolResult = taskResult.result().orElseThrow();
