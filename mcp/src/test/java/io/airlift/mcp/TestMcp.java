...
public class TestMcp
{
    ...
    public void testTools()
    {
        ...
        assertThat(listToolsResult.tools())
                ...
                .containsExactlyInAnyOrder("add", "addThree", "addFirstTwoAndAllThree", "throws");
        ...
        CallToolResult<String> callToolResult = objectMapper.convertValue(response.result().orElseThrow(), CallToolResult.class);
    ...
    public void testToolPrimitiveStructuredContent()
    {
        ...
        JsonRpcResponse<?> response = rpcCall(jsonrpcRequest);
        CallToolResult<String> callToolResult = objectMapper.convertValue(response.result().orElseThrow(), new TypeReference<>() {});
    ...
    public void testToolEmbeddedStructuredContent()
    {
        ...
        JsonRpcRequest<?> jsonrpcRequest = JsonRpcRequest.buildRequest(1, "tools/call", callToolRequest);
        JsonRpcResponse<?> response = rpcCall(jsonrpcRequest);
        CallToolResult<TestingEndpoints.TwoAndThree> twoAndThreeCallToolResult = objectMapper.convertValue(response.result().orElseThrow(), new TypeReference<>() {});
        assertThat(twoAndThreeCallToolResult.structuredContent())
                .isPresent()
                .get()
                .extracting(StructuredContent::value)
                .isEqualTo(new TestingEndpoints.TwoAndThree(3, 6));
    }
