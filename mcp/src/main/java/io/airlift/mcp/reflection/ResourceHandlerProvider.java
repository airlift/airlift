        ...
        implements Provider<ResourceEntry>
{
    ...
    public ResourceHandlerProvider(McpResource mcpResource, Class<?> clazz, Method method, List<MethodParameter> parameters)
    {
        ...
        validate(method, parameters, isHttpRequestOrContext.or(isIdentity).or(isReadResourceRequest).or(isSourceResource).or(isInputResponses), returnsResourceContents.or(returnsResourceContentsList));
