        ...
        implements McpNotifier
{
    ...
    InternalNotifier(Request request, ObjectMapper objectMapper, Meta meta, OutputStream output)
    {
        ...
        this.writer = new PrintWriter(output, false, UTF_8);
    ...
    {
        try {
            writer.println("id: " + "event-" + eventId.getAndIncrement());
            writer.println("data: " + encode(objectMapper.writeValueAsString(data)));
            writer.println();
            writer.flush();
        }
