        ...
        implements McpServer
{
    ...
    CallToolResult callTool(HttpServletRequest request, Authenticated<?> authenticated, MessageWriter messageWriter, CallToolRequest callToolRequest)
    {
        ...
        McpRequestContext requestContext = new InternalRequestContext(jsonMapper, sessionController, request, messageWriter, progressToken(callToolRequest), taskController);
        try {
    ...
    GetPromptResult getPrompt(HttpServletRequest request, Authenticated<?> authenticated, MessageWriter messageWriter, GetPromptRequest getPromptRequest)
    {
        ...
        McpRequestContext requestContext = new InternalRequestContext(jsonMapper, sessionController, request, messageWriter, progressToken(getPromptRequest), taskController);
    ...
    ReadResourceResult readResources(HttpServletRequest request, Authenticated<?> authenticated, MessageWriter messageWriter, ReadResourceRequest readResourceRequest)
    {
        ...
        McpRequestContext requestContext = new InternalRequestContext(jsonMapper, sessionController, request, messageWriter, progressToken(readResourceRequest), taskController);
    ...
    CompleteResult completionComplete(HttpServletRequest request, Authenticated<?> authenticated, InternalMessageWriter messageWriter, CompleteRequest completeRequest)
    {
        ...
        McpRequestContext requestContext = new InternalRequestContext(jsonMapper, sessionController, request, messageWriter, progressToken(completeRequest), taskController);
    ...
    Object resourcesSubscribe(HttpServletRequest request, Authenticated<?> authenticated, InternalMessageWriter messageWriter, SubscribeRequest subscribeRequest)
    {
        ...
        SessionId sessionId = requireSessionId(request);
        McpRequestContext requestContext = new InternalRequestContext(jsonMapper, sessionController, request, messageWriter, progressToken(subscribeRequest), taskController);
    ...
    {
        SessionId sessionId = requireSessionId(request);
        McpRequestContext requestContext = new InternalRequestContext(jsonMapper, sessionController, request, messageWriter, Optional.empty(), taskController);
    ...
    {
        McpRequestContext requestContext = new InternalRequestContext(jsonMapper, sessionController, request, messageWriter, Optional.of(getTaskRequest), taskController);
            ...
            while ((completionResult == null) && timeoutRemaining.isPositive()) {
                ...
                completionResult = switch (taskFacade.toTaskStatus()) {
                    case INPUT_REQUIRED -> {
                        ...
                        messageWriter.writeMessage(jsonMapper.writeValueAsString(message));
