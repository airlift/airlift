            ...
            throws Exception
    {
        ...
        Object result = switch (rpcMethod) {
            ...
            case METHOD_PROMPT_LIST ->
                    withManagement(request, requestId, messageWriter, () -> mcpServer.listPrompts(currentProtocol, convertParams(rpcRequest, ListRequest.class)));
            ...
            case METHOD_RESOURCES_LIST ->
                    withManagement(request, requestId, messageWriter, () -> mcpServer.listResources(currentProtocol, convertParams(rpcRequest, ListRequest.class)));
