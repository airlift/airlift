        ...
        extends HttpFilter
{
    ...
    private void handleRpcResponse(HttpServletRequest request, HttpServletResponse response, JsonRpcResponse<?> rpcResponse)
    {
        ...
        maybeTaskId.ifPresentOrElse(taskId -> mcpServer.acceptTaskResponse(request, taskId, rpcResponse),
            ...
            throws Exception
    {
        ...
        Object result = switch (rpcMethod) {
            ...
            case METHOD_LIST_TASKS -> mcpServer.listTasks(request, convertParams(rpcRequest, ListRequest.class));
            case METHOD_GET_TASK -> mcpServer.getTask(request, convertParams(rpcRequest, GetTaskRequest.class));
            case METHOD_GET_TASK_RESULT -> mcpServer.blockUntilTaskResult(request, convertParams(rpcRequest, GetTaskRequest.class));
            case METHOD_CANCEL_TASK -> mcpServer.blockUntilTaskCancelled(request, convertParams(rpcRequest, GetTaskRequest.class));
