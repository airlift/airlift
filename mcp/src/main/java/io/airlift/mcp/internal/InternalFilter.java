        ...
        extends HttpFilter
{
    ...
    private void handleEventStreaming(HttpServletRequest request, HttpServletResponse response, Authenticated<?> authenticated, SessionController sessionController)
    {
        ...
        InternalRequestContext requestContext = new InternalRequestContext(jsonMapper, Optional.of(sessionController), request, messageWriter, Optional.empty(), taskController);
            ...
            throws Exception
    {
        ...
        messageWriter.write(jsonMapper.writeValueAsString(rpcMessage));
        messageWriter.flushMessages();
    }
