...
import static io.airlift.mcp.operations.legacy.McpTracingAttributes.MCP_METHOD_NAME;
import static io.airlift.mcp.operations.legacy.McpTracingAttributes.MCP_PROTOCOL_VERSION;
