...
import static io.airlift.mcp.model.Protocol.PROTOCOL_MCP_2026_DRAFT_V1;
        ...
        implements Operations
{
    ...
    private Operations select(HttpServletRequest request)
    {
        ...
        Protocol protocol = maybeProtocolVersion
                ...
                .orElse(maybeProtocolVersion.isPresent() ? PROTOCOL_MCP_2026_DRAFT_V1 : LAST_LEGACY_PROTOCOL);
