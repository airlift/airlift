...
public interface SessionController
{
    ...
    /**
     * Delete a set of keys in the session. This operation is intended to be atomic if possible,
     * however this is not guaranteed.
     *
     * @return {@code true} if the deletions succeeded, {@code false} if the session ID is invalid
     */
    boolean deleteSessionValues(SessionId sessionId, Collection<? extends SessionKey<?>> keys);
}
