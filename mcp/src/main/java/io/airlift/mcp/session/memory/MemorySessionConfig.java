...
public class MemorySessionConfig
{
    ...
    private Duration eventRetention = Duration.valueOf("5m");
    ...
    @Config("mcp.memory-session.event-retention")
    public MemorySessionConfig setEventRetention(Duration eventRetention)
    {
