        ...
        implements McpStatelessServerTransport
{
    ...
    @Inject
    public ReferenceServerTransport(McpJsonMapper mcpJsonMapper, Optional<SessionController> sessionController, TaskEmulationDecorator taskEmulationDecorator)
    {
