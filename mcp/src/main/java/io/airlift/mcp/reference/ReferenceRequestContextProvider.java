        ...
        implements RequestContextProvider
{
    ...
    @Inject
    public ReferenceRequestContextProvider(ObjectMapper objectMapper, Optional<McpSessionController> sessionController, Provider<McpServer> server, ResponseListenerController responseListenerController)
    {
    ...
    {
        return new ReferenceRequestContext(request, response, server.get(), sessionController, progressToken, objectMapper, responseListenerController);
    }
}
