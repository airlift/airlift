        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(ResponseListenerController.class).in(SINGLETON);
    ...
    @Singleton
    @Provides
    public Optional<SessionHandlerAndTransport> sessionHandlerAndTransport(
            HttpServletStatelessServerTransport transport,
            ObjectMapper objectMapper,
            McpJsonMapper mcpObjectMapper,
            Optional<McpSessionController> sessionController,
            ResponseListenerController responseListenerController,
            ReferenceServerConfig referenceServerConfig)
    {
