...
public class Tasks
{
    ...
    Tasks(SessionController sessionController, CancellationController cancellationController, TaskContextId taskContextId, Object requestId, int defaultTaskTtlMs, int defaultPingThresholdMs)
    {
    ...
    {
        TaskBuilder withMeta(Meta meta);
    ...
    public TaskBuilder taskBuilder()
    {
        return new TaskBuilder()
        {
            ...
            @Override
            public TaskBuilder withMeta(Meta meta)
            {
            ...
            public TaskFacade createTask()
            {
                ...
                TaskFacade taskFacade = new TaskFacade(
                        ...
                        progressToken,
                        Optional.empty(),
                        pollInterval.orElse(defaultPingThresholdMs),
                        Optional.empty(),
                        ttl.orElse(defaultTaskTtlMs),
                        Optional.empty(),
                        false,
                        ImmutableMap.of());
