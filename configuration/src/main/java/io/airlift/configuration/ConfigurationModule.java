...
public class ConfigurationModule implements Module {
    ...
    public void configure(Binder binder) {
        ...
        configurationFactory
                ...
                .forEach(configurationProvider -> bindConfigurationProvider(binder, configurationProvider));
    }
    ...
    public static class ConfigBindingBuilder {
        ...
        public ConfigBindingBuilder(
                Binder binder, Class<? extends Annotation> annotationType, Annotation annotation, String prefix) {
            this.binder = binder;
