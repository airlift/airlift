...
public class TestConfigurationInspector {
    ...
    public void testDefaultValue() {
        List<String> defaultString = getConfigRecord().getAttributes().stream()
    ...
    public void testCurrentValue() {
        List<String> currentString = getConfigRecord().getAttributes().stream()
    ...
    private ConfigRecord<?> getConfigRecord() {
        ...
        configurationFactory.registerConfigurationClasses(
                binder -> configBinder(binder).bindConfig(ConfigWithOptionalValue.class));
        return new ConfigurationInspector()
                .inspect(configurationFactory).stream().collect(onlyElement());
    }
