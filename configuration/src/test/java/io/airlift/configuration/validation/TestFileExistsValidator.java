...
public class TestFileExistsValidator {
    ...
    public void testFileDoesNotExist() {
        assertFailsValidation(
                new TestedBean(Paths.get("./file-not-exist.xml")),
                "testedValue",
                "file does not exist: ./file-not-exist.xml",
                FileExists.class);
        assertFailsValidation(
                new TestedBean(Paths.get("./some-name.xml").toFile()),
                "testedValue",
                "file does not exist: ./some-name.xml",
                FileExists.class);
        assertFailsValidation(
                new TestedBean("./some-other-name.xml"),
                "testedValue",
                "file does not exist: ./some-other-name.xml",
                FileExists.class);
    }
