...
public class AutomaticMutualTls
{
    private AutomaticMutualTls() {}
            ...
            implements X509TrustManager
    {
        ...
        private void check(X509Certificate[] chain)
        {
            ...
            PublicKey peerKey = chain[0].getPublicKey();
            ...
            X500Principal peerSubject = chain[0].getSubjectX500Principal();
