...
class TestAutomaticMutualTls
{
    @Test
    public void testTrustManager()
            throws GeneralSecurityException
    {
        X509Certificate certificate = AutomaticMutualTls.certificateBuilder("sharedSecret", "commonName")
    ...
    {
        AutomaticMutualTls.createTrustManager(sharedSecret, commonName).checkClientTrusted(new X509Certificate[] {certificate}, "ECDSA");
    }
}
