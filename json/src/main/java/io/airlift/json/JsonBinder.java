...
public class JsonBinder
{
    ...
    private JsonBinder(Binder binder)
    {
        ...
        keySerializerMapBinder = MapBinder.newMapBinder(binder, new TypeLiteral<Class<?>>() {}, new TypeLiteral<ValueSerializer<?>>() {}, JsonKeySerde.class);
        ...
        serializerMapBinder = MapBinder.newMapBinder(binder, new TypeLiteral<Class<?>>() {}, new TypeLiteral<ValueSerializer<?>>() {});
        deserializerMapBinder = MapBinder.newMapBinder(binder, new TypeLiteral<Class<?>>() {}, new TypeLiteral<ValueDeserializer<?>>() {});
