...
public class TestHttpDiscoveryLookupClient {
    ...
    public void testCreateServiceLocation() {
        ...
        assertThat(createServiceLocation(URI.create("http://example.com:8080"), "abc", Optional.empty()))
                .isEqualTo(expected);
        assertThat(createServiceLocation(URI.create("http://example.com:8080/"), "abc", Optional.empty()))
                .isEqualTo(expected);

        expected = URI.create("https://example.com:8080/v1/service/abc");
        assertThat(createServiceLocation(URI.create("https://example.com:8080"), "abc", Optional.empty()))
                .isEqualTo(expected);
        assertThat(createServiceLocation(URI.create("https://example.com:8080/"), "abc", Optional.empty()))
                .isEqualTo(expected);

        expected = URI.create("http://example.com:8080/v1/service/abc/xyz");
        assertThat(createServiceLocation(URI.create("http://example.com:8080"), "abc", Optional.of("xyz")))
                .isEqualTo(expected);
        assertThat(createServiceLocation(URI.create("http://example.com:8080/"), "abc", Optional.of("xyz")))
                .isEqualTo(expected);
    }
