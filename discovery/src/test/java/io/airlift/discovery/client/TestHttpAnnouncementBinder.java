...
public class TestHttpAnnouncementBinder
{
    ...
    public void testHttpAnnouncement()
    {
        ...
        ServiceAnnouncement announcement = serviceAnnouncement("apple")
                .addProperty("http", httpServerInfo.httpUri().toASCIIString())
                .addProperty("http-external", httpServerInfo.httpExternalUri().toASCIIString())
                .build();
    ...
    public void testHttpsAnnouncement()
    {
        ...
        ServiceAnnouncement announcement = serviceAnnouncement("apple")
                .addProperty("https", httpServerInfo.httpsUri().toASCIIString())
                .addProperty("https-external", httpServerInfo.httpsExternalUri().toASCIIString())
                .build();
