...
public class TestHttpAnnouncementBinder {
    ...
    public void testHttpAnnouncement() {
        ...
        Injector injector = Guice.createInjector(new TestingDiscoveryModule(), binder -> {
        ...
        ServiceAnnouncement announcement = serviceAnnouncement("apple")
                ...
                .addProperty(
                        "http-external", httpServerInfo.getHttpExternalUri().toASCIIString())
                .build();
    ...
    public void testHttpsAnnouncement() {
        StaticAnnouncementHttpServerInfoImpl httpServerInfo = new StaticAnnouncementHttpServerInfoImpl(
                null, null, URI.create("https://127.0.0.1:4444"), URI.create("https://example.com:4444"));
        ...
        ServiceAnnouncement announcement = serviceAnnouncement("apple")
                ...
                .addProperty(
                        "https-external", httpServerInfo.getHttpsExternalUri().toASCIIString())
                .build();
    ...
    public void testHttpAnnouncementWithCustomProvidedProperties() {
        ...
        assertAnnouncement(
                ...
                serviceAnnouncement("apple")
                        ...
                        .addProperty(
                                "provided-by-injected", "concatenated: http://127.0.0.1:4444 https://127.0.0.1:4444")
