...
public class UriServiceInventory
        implements ServiceInventory
{
    private static final Logger log = Logger.get(UriServiceInventory.class);
    ...
    @Inject
    public UriServiceInventory(UriServiceInventoryConfig config,
            NodeInfo nodeInfo,
    ...
    public final void updateServiceInventory()
    {
        ...
        try {
            ...
            serviceDescriptors.set(ImmutableList.copyOf(serviceDescriptorsRepresentation.getServiceDescriptors()));
