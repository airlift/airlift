...
/// FullJsonResponseHandler is a [ResponseHandler] that creates a JSON entity from the response bytes when Content-Type
/// is application/json. In contrast to [StreamingJsonResponseHandler] it always buffers a whole response, materializing
...
/// [StreamingJsonResponseHandler] should be used instead.
