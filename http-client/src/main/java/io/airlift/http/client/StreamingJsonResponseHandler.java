...
/// StreamingJsonResponseHandler is a [ResponseHandler] that creates a JSON entity from the response bytes when Content-Type
/// is application/json. In contrast to [FullJsonResponseHandler] it always reads data directly from an InputStream
