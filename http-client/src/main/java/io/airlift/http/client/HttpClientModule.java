        ...
        implements Module
{
            ...
            implements Provider<HttpClient>
    {
        ...
        public HttpClient get()
        {
            ...
            Optional<SslContextFactory.Client> sslContextFactoryGeneric = injector.getInstance(Key.get(new TypeLiteral<>() {}));
            Optional<SslContextFactory.Client> sslContextFactory = sslContextFactoryAnnotated.or(() -> sslContextFactoryGeneric);
