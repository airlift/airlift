...
public final class ResponseHandlerUtils
{
    ...
    public static UnexpectedResponseException captureUnexpectedResponse(String message, Request request, Response response, int maxResponseBodyBytes)
    {
        ...
        return UnexpectedResponseException.builder(message, response.getStatusCode())
                .setRequest(request)
                .setHeaders(response.getHeaders())
                .setResponseBody(capturedBody.bytes(), capturedBody.truncated())
                .setCause(capturedBody.failure())
                .build();
    }
