...
public class TestFullJsonResponseHandler
{
    ...
    public void testInvalidJson()
    {
        ...
        assertEquals(response.getException().getCause().getMessage(), "Invalid JSON bytes for [simple type, class com.facebook.airlift.http.client.TestFullJsonResponseHandler$User]");
