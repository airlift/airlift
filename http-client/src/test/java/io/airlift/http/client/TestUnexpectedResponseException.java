...
class TestUnexpectedResponseException
{
    ...
    @Test
    void testStructuredFailureIsBoundedAndDiagnosticsAreRedacted()
    {
        ...
        TestingResponse response = new TestingResponse(
                ...
                ImmutableListMultimap.of(
                        ...
                        HeaderName.of("Set-Cookie"), "session=secret"),
        ...
        assertThat(exception.getRequestUri()).isEqualTo(URI.create("https://example.test:8443/v1/items"));
        assertThat(exception.getStatusCode()).isEqualTo(500);
        assertThatThrownBy(() -> exception.getHeaders().put(CONTENT_TYPE, "text/plain"))
                .isInstanceOf(UnsupportedOperationException.class);
        assertThat(exception.getHeader(CONTENT_TYPE)).isEqualTo("application/json; charset=utf-8");
        ...
        assertThat(exception.toString())
                ...
                .doesNotContain("secret", "Set-Cookie", "application/json", "responseBody", "headers");
    }
    ...
    void testFailureBodyReadErrorRetainsStructuredResponse()
    {
        ...
        assertThat(exception).hasCauseInstanceOf(java.io.UncheckedIOException.class);
    }
    ...
    void testSanitizedUriPreservesRawPath()
    {
        ...
        assertThat(exception.getRequestUri())
