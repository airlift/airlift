    ...
    public void testInvalidJson() {
        ...
        try {
            ...
            assertThat(e.getMessage())
                    .isEqualTo(format("Unable to create %s from JSON response: <%s>", User.class, json));
    ...
    public void testNonJsonResponse() {
        assertThatThrownBy(() -> handler.handle(null, mockResponse(OK, PLAIN_TEXT_UTF_8, "hello")))
                ...
                .hasMessageContaining(
                        "Expected application/json response from server but got text/plain; charset=utf-8");
    }
