            ...
            throws SQLException
    {
        ...
        for (ServiceDescriptor serviceDescriptor : serviceSelector.selectAllServices()) {
            ...
            try {
                ...
                int timeout = getMaxConnectionWaitMillis() * 1000;
        ...
        throw new SQLException(String.format("No PostgreSQL servers of type '%s' available in pool '%s'", serviceSelector.getType(), serviceSelector.getPool()));
    }
}
