...
public class TestH2EmbeddedDataSourceModule
{
    ...
    public void testObjectBindingFromInjector()
    {
        ...
        assertThat(objectHolder.dataSource).isInstanceOf(H2EmbeddedDataSource.class);
    }
    ...
    public void testAliasedBindingBindsCorrectly()
    {
        ...
        assertThat(twoObjectsHolder.mainDataSource).isInstanceOf(H2EmbeddedDataSource.class);
        assertThat(twoObjectsHolder.aliasedDataSource).isInstanceOf(H2EmbeddedDataSource.class);
