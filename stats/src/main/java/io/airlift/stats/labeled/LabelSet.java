...
public class LabelSet
{
    ...
    public static final Comparator<LabelSet> LABEL_SET_COMPARATOR = (labelSetOne, labelSetTwo) -> {
        Map<String, String> labelsOne = labelSetOne.asMap();
        Map<String, String> labelsTwo = labelSetTwo.asMap();
        Iterator<Map.Entry<String, String>> it1 = labelsOne.entrySet().iterator();
        Iterator<Map.Entry<String, String>> it2 = labelsTwo.entrySet().iterator();
        ...
        while (it1.hasNext() && it2.hasNext()) {
            ...
            cmp = e1.getValue().compareTo(e2.getValue());
            if (cmp != 0) {
                return cmp;
            }
        }
        return Integer.compare(labelsOne.size(), labelsTwo.size());
    };
    ...
    private static ImmutableMap<String, String> canonicalize(Map<String, String> labels)
    {
        ...
        String[] keys = labels.keySet().toArray(new String[0]);
        Arrays.sort(keys);
