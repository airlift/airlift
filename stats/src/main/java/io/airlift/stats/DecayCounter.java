...
public final class DecayCounter {
    ...
    public synchronized void merge(DecayCounter decayCounter) {
        ...
        checkArgument(
                decayCounter.alpha == alpha,
                "Expected decayCounter to have alpha %s, but was %s",
                alpha,
                decayCounter.alpha);
        ...
        synchronized (decayCounter) {
            ...
            if (landmarkInSeconds < decayCounter.landmarkInSeconds) {
                ...
                double otherRescaledCount =
                        decayCounter.count / weight(alpha, landmarkInSeconds, decayCounter.landmarkInSeconds);
    ...
    public synchronized double getRate() {
        // The total time covered by this counter is equivalent to the integral of the weight function from 0 to
        // Infinity,
