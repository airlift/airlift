...
public class CpuTimer {
    ...
    public CpuDuration startNewInterval() {
        ...
        CpuDuration cpuDuration = new CpuDuration(
                ...
                // currentUserTime is -1 when ThreadMXBean does not support user collection or when collectUserTime is
                // false
    ...
    public record CpuDuration(
            Duration wall, Duration cpu, @Nullable Duration user) {
        public CpuDuration() {
