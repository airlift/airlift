...
public class TestDecayConfig
{
    ...
    {
        assertThat(DecayConfig.all().getAlpha()).isEqualTo(0.0);
        assertThat(DecayConfig.oneMinute().getAlpha()).isEqualTo(1.0 / 60);
        assertThat(DecayConfig.fiveMinutes().getAlpha()).isEqualTo(1.0 / 300);
        assertThat(DecayConfig.fifteenMinutes().getAlpha()).isEqualTo(1.0 / 900);
        assertThat(DecayConfig.seconds(10).getAlpha()).isEqualTo(1.0 / 10);
        assertThat(DecayConfig.of(0.5).getAlpha()).isEqualTo(0.5);
    }

    @Test
    public void testIsDecaying()
    {
        assertThat(DecayConfig.all().isDecaying()).isFalse();
        assertThat(DecayConfig.oneMinute().isDecaying()).isTrue();
    }
    ...
    public void testNewStateIsIndependentWithFreshLandmark()
    {
        ...
        assertThat(first.getLandmarkInSeconds()).isEqualTo(0);
        assertThat(first.getAlpha()).isEqualTo(config.getAlpha());
    }
    ...
    public void testNewStateWithLandmark()
    {
        ...
        assertThat(state.isDecaying()).isTrue();

        DecayState noDecay = DecayConfig.of(0).newState(0);
        assertThat(noDecay.isDecaying()).isFalse();
    }
}
