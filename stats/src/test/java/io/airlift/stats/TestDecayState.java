...
public class TestDecayState
{
    ...
    @Test
    public void testNoDecayWeightIsAlwaysOne()
    {
        TestingTicker ticker = new TestingTicker();
        DecayState decay = DecayConfig.all(ticker).newState();

        assertThat(decay.currentWeight()).isEqualTo(1.0);
        assertThat(decay.weightAt(123_456)).isEqualTo(1.0);
    ...
    @Test
    public void testNoDecayNeverNeedsRescale()
    {
        assertThat(DecayConfig.all().newState().needsRescale(Long.MAX_VALUE)).isFalse();
    }
