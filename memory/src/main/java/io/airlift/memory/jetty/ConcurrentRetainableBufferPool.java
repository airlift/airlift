        ...
        implements ByteBufferPool
{
    ...
    public ConcurrentRetainableBufferPool(long maxHeapMemory, long maxOffHeapMemory)
    {
        ...
        this.maxHeapMemory = (maxHeapMemory > 0) ? maxHeapMemory : DataSize.of(1, MEGABYTE).toBytes();
        this.maxOffHeapMemory = (maxOffHeapMemory > 0) ? maxOffHeapMemory : DataSize.of(1, MEGABYTE).toBytes();
        this.checkCount = 0;
