        ...
        implements LoggingBootstrap, Module
{
    ...
    public synchronized void initializeLogging(LoggingBootstrapContext context)
    {
        ...
        OpenTelemetryLogHandler handler = new OpenTelemetryLogHandler(resource, logRecordProcessor, context);
        SdkLoggerProvider loggerProvider = handler.getLoggerProvider();

        context.addRootHandler(handler);
        this.logRecordProcessor = Optional.of(logRecordProcessor);
