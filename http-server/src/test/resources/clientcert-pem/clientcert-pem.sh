...
# create server key
openssl genrsa 4096 | openssl pkcs8 -topk8 -inform pem -outform pem -passout pass:airlift -out server.key
...
# create client key
openssl genrsa 4096 | openssl pkcs8 -topk8 -inform pem -outform pem -passout pass:airlift -out client.key
