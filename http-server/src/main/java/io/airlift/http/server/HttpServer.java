...
public class HttpServer
{
            ...
            throws IOException
    {
        ...
        if (config.isHttpEnabled()) {
            ...
            httpConnector.setMaxIdleTime((int) config.getNetworkMaxIdleTime().getValue(TimeUnit.MILLISECONDS));
        ...
        if (config.isHttpsEnabled()) {
            ...
            httpsConnector.setMaxIdleTime((int) config.getNetworkMaxIdleTime().getValue(TimeUnit.MILLISECONDS));
        ...
        if (theAdminServlet != null && config.isAdminEnabled()) {
            ...
            adminConnector.setMaxIdleTime((int) config.getNetworkMaxIdleTime().getValue(TimeUnit.MILLISECONDS));
            ...
            adminThreadPool.setMaxIdleTimeMs((int) config.getThreadMaxIdleTime().getValue(TimeUnit.MILLISECONDS));
        ...
        threadPool.setMaxIdleTimeMs((int) config.getThreadMaxIdleTime().getValue(TimeUnit.MILLISECONDS));
            ...
            throws IOException
    {
        ...
        RequestLog requestLog = new DelimitedRequestLog(config.getLogPath(), (int) config.getLogRetentionTime().getValue(TimeUnit.DAYS), tokenManager, eventClient);
