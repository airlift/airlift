        ...
        extends AbstractConfigurationAwareModule
{
    ...
    public HttpServerModule(@Nullable Class<? extends Annotation> qualifier, @Nullable String configPrefix)
    {
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(qualifiedKey(HttpServer.class))
                .toProvider(new HttpServerProvider(qualifier))
                .in(SINGLETON);
        ...
        newOptionalBinder(binder, qualifiedKey(ByteBufferPool.class));
