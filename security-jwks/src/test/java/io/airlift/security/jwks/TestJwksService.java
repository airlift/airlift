...
public class TestJwksService
{
    ...
    {
        HttpClient httpClient = new TestingHttpClient(_ -> mockResponse(HttpStatus.OK, JSON_UTF_8, TEST_JWKS_RESPONSE));
    ...
    public void testReload()
    {
        ...
        JwksService service = new JwksService(URI.create("http://example.com"), new TestingHttpClient(_ -> response.get()), new Duration(1, DAYS));
            ...
            throws InterruptedException
    {
        ...
        JwksService service = new JwksService(URI.create("http://example.com"), new TestingHttpClient(_ -> response.get().get()), new Duration(1, MILLISECONDS));
        assertEmptyKeys(service);
