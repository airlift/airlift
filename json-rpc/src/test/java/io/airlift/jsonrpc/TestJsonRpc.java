        ...
        extends TestBase
{
    ...
    public void testSetPerson()
    {
        ...
        JsonRpcResponse<Object> putResponse = httpClient.execute(request, createJsonResponseHandler(jsonCodec(new TypeToken<>() {})));
        assertThat(putResponse.id()).isEqualTo(id);
        assertThat(putResponse.result()).isEmpty();
        assertThat(putResponse.error()).isEmpty();
