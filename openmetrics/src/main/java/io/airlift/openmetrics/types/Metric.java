...
public interface Metric
{
    ...
    static String formatSingleValuedMetric(String name, List<Map.Entry<String, String>> labels, String type, String help, String value)
    {
    ...
    static String formatNameWithLabels(String name, List<Map.Entry<String, String>> labels)
    {
        if (labels.isEmpty()) {
            return name;
        }
