...
public class OpenMetricsCollector
{
            ...
            Supplier<Metric> fallback)
    {
        ...
        // how each existing bucket's count is distributed between finer buckets. Falling back only
        // this series to a summary could mix metric types within a family and fail the entire scrape,
        // so omit the unrepresentable series. Text exposition still publishes it as a summary.
