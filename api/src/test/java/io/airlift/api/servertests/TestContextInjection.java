...
import static io.airlift.api.TestApiContext.API_BUILDER_CONFIG;
...
public class TestContextInjection
{
    ...
    public void testApplicationValueProvider()
    {
        Injector injector = new Bootstrap(
                ...
                ApiModule.builder().withApiBuilderConfig(API_BUILDER_CONFIG).addApi(builder -> builder.add(ContextService.class)).build())
